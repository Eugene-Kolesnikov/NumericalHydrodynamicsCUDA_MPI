...
${OBJECTDIR}/ComputationalModel.o: ComputationalModel.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ComputationalModel.o ComputationalModel.cpp

${OBJECTDIR}/ComputationalNode.o: ComputationalNode.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ComputationalNode.o ComputationalNode.cpp

${OBJECTDIR}/LatticeBoltzmannModel.o: LatticeBoltzmannModel.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LatticeBoltzmannModel.o LatticeBoltzmannModel.cpp

${OBJECTDIR}/MPI_Node.o: MPI_Node.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MPI_Node.o MPI_Node.cpp

${OBJECTDIR}/ServerNode.o: ServerNode.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ServerNode.o ServerNode.cpp

${OBJECTDIR}/gpu_mpi_main.o: gpu_mpi_main.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gpu_mpi_main.o gpu_mpi_main.cpp
