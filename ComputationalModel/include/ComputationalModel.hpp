 ...
 * TODO: Replace 'void* getCPUHaloPtr(size_t border_type)', 'void* getCPUDiagHaloPtr(size_t border_type)'
 * with one function getCPUHaloPtr(enum HaloType {border, diagonal}, size_t border_type).
 */
