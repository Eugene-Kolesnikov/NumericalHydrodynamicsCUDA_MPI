...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libDynamicLibraryVisualization.${CND_DLIB_EXT}: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libDynamicLibraryVisualization.${CND_DLIB_EXT} ${OBJECTFILES} ${LDLIBSOPTIONS} -lglfw3 -fobjc-arc -framework Cocoa -framework OpenGL -framework IOKit -framework CoreVideo -lpng -lavcodec -lswscale -lavutil -dynamiclib -install_name libDynamicLibraryVisualization.${CND_DLIB_EXT} -fPIC

${OBJECTDIR}/FieldObject.o: FieldObject.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FieldObject.o FieldObject.cpp

${OBJECTDIR}/MainWindow.o: MainWindow.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MainWindow.o MainWindow.cpp

${OBJECTDIR}/interface.o: interface.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/interface.o interface.cpp

${OBJECTDIR}/offscreen.o: offscreen.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/offscreen.o offscreen.c
