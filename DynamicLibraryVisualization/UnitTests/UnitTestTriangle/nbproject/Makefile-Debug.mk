...
LDLIBSOPTIONS=-L../DynamicLibraryVisualization/dist/Release/CLang-MacOSX -lDynamicLibraryVisualization
...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/unittesttriangle: ../DynamicLibraryVisualization/dist/Release/CLang-MacOSX/libDynamicLibraryVisualization.dylib
...
${OBJECTDIR}/drawSimpleField.o: drawSimpleField.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/drawSimpleField.o drawSimpleField.cpp
